========================================================================
    KONSOLENANWENDUNG: WindowManagerEngineKrams-Projektübersicht
========================================================================

Diese WindowManagerEngineKrams-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre WindowManagerEngineKrams-Anwendung besteht.


WindowManagerEngineKrams.vcxproj
...
WindowManagerEngineKrams.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen WindowManagerEngineKrams.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
