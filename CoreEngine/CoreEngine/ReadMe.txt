========================================================================
    KONSOLENANWENDUNG: CoreEngine-Projektübersicht
========================================================================

Diese CoreEngine-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CoreEngine-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CoreEngine.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
